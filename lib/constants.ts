...
export const BOARD_WIDTH = GRID_SIZE * CELL_SIZE + (GRID_SIZE - 1) * CELL_GAP + BOARD_PADDING * 2;
export const BOARD_HEIGHT = GRID_SIZE * CELL_SIZE + (GRID_SIZE - 1) * CELL_GAP + BOARD_PADDING * 2;
